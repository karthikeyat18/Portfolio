...
SUPABASE_URL = "https://wenseduclmmfigfxptmr.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndlbnNlZHVjbG1tZmlnZnhwdG1yIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTA3Mjc0NCwiZXhwIjoyMDg0NjQ4NzQ0fQ.ZIGTXGoMUrQZGYIrkxp6HCn6SmRHNlv9eDC9R1yR0Tc" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES1UG23CS287.png"  # Replace with the local image path
image_name = "PES1UG23CS287.png"  # Desired name for the uploaded file
